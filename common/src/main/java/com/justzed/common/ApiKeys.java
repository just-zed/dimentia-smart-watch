...
public class ApiKeys {
    ...
    public static final String PARSE_API_PROD_APPLICATION_ID = "UAPzdvALR0oYGt1nJRciD4pvLIhpqAxaWFyBtaom";
    public static final String PARSE_API_PROD_CLIENT_KEY = "uUFGLbFgoRJIoTs3rmrh0AB51PvXEy2jd31CyJjm";
}
